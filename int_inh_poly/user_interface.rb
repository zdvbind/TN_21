...
def add_station_to_route
  ...
  if Station.find_by_name(title_station).nil?
    ...
    Route.find_by_name(title_route).add_station(Station.find_by_name(title_station))
  end
end
...
def remove_station_from_route
  ...
  if Station.find_by_name(title_station).nil?
    ...
    Route.find_by_name(title_route).del_station(Station.find_by_name(title_station))
  end
end
