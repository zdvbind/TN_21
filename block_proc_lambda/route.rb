class Route
  ...
  def validate!
    ...
    raise ArgumentError, 'Name of first station can not be empty or nil' if @station_list[0].nil? || @station_list[0].title.empty?
    raise ArgumentError, 'Name of last station can not be empty or nil' if @station_list[-1].nil? || @station_list[-1].title.empty?
  end
end
